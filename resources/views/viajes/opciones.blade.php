    <div class="__opciones-viajes">
        ...
        <div class="__opc-conductor">
            <a href="#modal-agregarViaje" id="cerrar" class="__btn __agregarViaje"><i class="fa-solid fa-plus"></i> Crear viaje</a>
            <a href="#modal-autoCrear" class="__btn __agregarAuto"><i class="fa-solid fa-plus"></i> Agregar auto</a>
