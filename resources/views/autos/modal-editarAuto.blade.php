    ...
    <div class="modal modal-agregarAuto" id="modal-autoEditar-{{ $auto->id }}">
        ...
        <div class="__body">
            ...
            <div>
                ...
                <div class="__horario">
                    <input type="text" name="placa" id="" title="Numero de placa"
                        placeholder="Numero de placa" value="{{ $auto->placa }}">
                    <span> - </span>
                    <input type="text" name="no_seguro" title="Seguro" placeholder="No. seguro"
                        value="{{ $auto->no_seguro }}">
                </div>
                <div class="__horario">
                    ...
                    <span> - </span>
                    <input type="text" name="capacidad" title="Capacidad" placeholder="Capacidad"
                ...
                <div class="__checks">
                    <div class="__checkbox">
                        <input type="checkbox" id="activo" name="activo" value="true"
                            {{ $auto->activo == 1 ? 'checked' : '' }}>
                        <p>Activo</p>
                    </div>
                    <div class="__checkbox"s>
                        <input type="checkbox" id="verificado" name="verificado" value="true"
                            {{ $auto->verificado == 1 ? 'checked' : '' }}>
                        <p>Verificado</p>
                    </div>
                </div>
            </div>
