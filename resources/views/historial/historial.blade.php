...
@section('contenido')
    ...
    <section class="historial">
        <p class="__bienvenida">Hola xxxxxxxxxxxxxxxxxxx. Se muestran los resultados de los raites en los que has
            participado como pasajero</p>
        <div class="__contenedor">
            <div class="__tarjeta __normalBorde __historial">
                <div class="__img">
            ...
            <div class="__cuerpo __normalBorde">
                <div class="__encabezado">
                    <div>
                        <i class="fa-solid fa-circle __normalEstatus"></i>
                        <p>Estatus</p>
                    </div>
                    <p>Codigo de viaje: ############</p>
                </div>
